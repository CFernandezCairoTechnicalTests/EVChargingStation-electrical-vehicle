...
public class ChargingStationServiceImpl implements ChargingStationService {
    ...
    @Override
    @Cacheable("chargingstation_available")
    public Optional<ChargingStation> getChargingStationAvailableById(String id) {
        return chargingStationRepository.findBychargingStationId(id);
    }
